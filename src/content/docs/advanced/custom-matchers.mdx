...
description: Creating custom matchers in EasyTest
slug: advanced/custom-matchers
---

EasyTest provides a powerful way to create custom matchers, allowing you to extend the functionality of the built-in matchers to suit your specific testing needs. 
