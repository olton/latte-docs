...
1. Open the `Run and Debug` panel in VSC (Ctrl+Shift+D).
2. Click on `create a launch.json file`.
3. Select `Node.js` from the list.
4. In the `program` field, add the following: `${workspaceFolder}/node_modules/@olton/easytest/cli/easytest.js`.
    ...
    "configurations": [
        {
            ...
            "program": "${workspaceFolder}/node_modules/@olton/easytest/cli/easytest.js",
            "args": ["--debug"],
            "cwd": "${workspaceFolder}"
        }
    ]
